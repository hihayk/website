...
function optionsframework_admin_message() { 
	...
	$documentation_location = "<b>Documentation and sample data</b><br/> <p>To get to the documentation first make sure you downloaded the Mainfile(s) from your Themeforest downloads and not just the installable file, unzip this file and go into ninezeroseven_WP_v".THEMEVERSION."/Documentation/ and open index.html in your web browser.</p>";
    ...
    jQuery(function(){
        ...
        var message = '<p>This theme comes with an <a href="<?php echo admin_url('admin.php?page=optionsframework'); ?>">options panel</a> to configure settings. This theme also supports widgets, please visit the <a href="<?php echo admin_url('widgets.php'); ?>">widgets settings page</a> to configure them.</p><?php echo $documentation_location; ?>';
