...
class ZillaShortcodes {
	...
	function add_rich_plugins( $plugin_array )
	{
		...
		if ( floatval( get_bloginfo('version') ) >= 3.9 ){
			...
			$plugin_array['zillaShortcodes'] = get_template_directory_uri().'/admin/zilla-shortcodes/tinymce/plugin.prev.js';
		}
	...
	function admin_init()
	{
		...
		if ( floatval( get_bloginfo('version') ) >= 3.9 ){
			...
			wp_enqueue_script( 'zilla-popup', ZILLA_TINYMCE_URI . '/js/popup.prev.js', false, '1.0', false );
		}
